...
cd /d "C:\Users\k1yt\OneDrive\문서\각종자료\공부자료들\파이썬_Python\crowsmemory"
set "PORT=9020"
set "HTTP_PORT=9021"
set "LOG_FILE=C:\Users\k1yt\OneDrive\문서\각종자료\공부자료들\파이썬_Python\crowsmemory\sse_server.log"
set "LOCK_FILE=C:\Users\k1yt\OneDrive\문서\각종자료\공부자료들\파이썬_Python\crowsmemory\memory\crow.bin.lock"
set "STATE_PATH=C:\Users\k1yt\OneDrive\문서\각종자료\공부자료들\파이썬_Python\crowsmemory\memory\crow.bin"
set "READY_FILE=C:\Users\k1yt\OneDrive\문서\각종자료\공부자료들\파이썬_Python\crowsmemory\memory\.crow_ready"
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  "$p = Start-Process -FilePath 'C:\Program Files\Python312\python.exe' -ArgumentList '-X utf8 \"C:\Users\k1yt\OneDrive\문서\각종자료\공부자료들\파이썬_Python\crowsmemory\crow_mcp_server.py\" --state \"%STATE_PATH%\" --transport dual --port %PORT% --http-port %HTTP_PORT% --ready-file \"%READY_FILE%\"' -WindowStyle Hidden -PassThru; ^
