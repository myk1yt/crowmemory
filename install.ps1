...
# Step 3: Configure MCP server (.roo/mcp.json for Zoo Code)
Write-Host "[3/5] Configuring MCP server (SSE mode) for Zoo Code..." -ForegroundColor Yellow
$RooDir = "$CrowDir\.roo"
...
Write-Host "[3.5/5] Creating .vscode/tasks.json (auto-start SSE on folder open)..." -ForegroundColor Yellow
